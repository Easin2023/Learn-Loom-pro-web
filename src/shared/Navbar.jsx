  ...
  return (
    <div className="navbar bg-base-100">
      <div className="navbar-start">
        ...
        <Link
          to="/"
          className="hover:bg-red-200 rounded-lg ease-out duration-300"
        >
          <img className="w-[300px]" src={LogoImage} alt="" />
        </Link>
      </div>
      <div className="navbar-center hidden lg:flex mt-6 lg:ml-80">
        ...
        {user ? (
          <>
            <div className=" relative dropdown dropdown-end">
              ...
              <ul
                tabIndex={0}
                className="menu absolute menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52"
              >
