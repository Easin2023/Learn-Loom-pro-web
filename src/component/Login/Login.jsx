    ...
    <div>
      ...
      <div>
        <section className="bg-red-50">
          <div className="lg:grid lg:min-h-[840px] lg:grid-cols-12">
            <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
              <img
                alt="Night"
                src="https://images.unsplash.com/photo-1551818567-d49550a81408?q=80&w=1287&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ...
            <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
              <div className="max-w-xl lg:max-w-3xl">
                ...
                <div>
                  <div>
                    <h1 className="font-bold text-2xl text-center my-4 underline">
                      pleas login{" "}
                    </h1>
                  </div>
                  <form onSubmit={handleSubmit} className="mt-8 grid  grid-cols-6 gap-6 mb-10">
                    ...
                    <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                      ...
                      <p className="mt-4 text-sm text-gray-500 sm:mt-0">
                        ...
                        <Link to="/signIn">
                          <button className="btn btn-link">SignIn up</button>
                        </Link>
                      </p>
                    </div>
                  </form>
